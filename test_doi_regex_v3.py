...
test_cases = [
    ...
    ("10.1000/abc(def)ghi", "10.1000/abc(def)ghi"),
]

# Option E: Handles balanced parens (one level) and excludes trailing punctuation
# Pattern: 10\.\d{4,9}/(?:[-._;()/:A-Z0-9<>]|\([-._;()/:A-Z0-9<>]+\))+(?<![.;,])
patterns = [
    (r"Option E (Balanced Parens)", r"10\.\d{4,9}/(?:[-._;/:A-Z0-9<>]|\([-._;/:A-Z0-9<>]+\))+(?<![.;,])"),
]
